...
import com.hackathon.SignIn.Constants;
import com.hackathon.SignIn.SharedPrefManager;
import com.hackathon.SignIn.User;
import com.hackathon.SignIn.Utils;
...
public class SignInActivity extends BaseActivity implements View.OnClickListener,GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isVerfied=getSharedPreferences("isverf",MODE_PRIVATE).getBoolean("isVerfied",false);
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity.this, "Login successful",
                                    Toast.LENGTH_SHORT).show();
                            getSharedPreferences("isverf",MODE_PRIVATE).edit().putBoolean("isVerfied",true).commit();
                            Intent intent = new Intent(SignInActivity.this, NavDrawerActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                            finish();
